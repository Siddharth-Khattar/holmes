...
- Dev dependencies:
  - ruff>=0.14.0
  - mypy>=1.0.0
  - (no Python typegen dependency; TypeScript types are generated from FastAPI OpenAPI via openapi-typescript)
...
- generate-types: make generate-types  # exports FastAPI OpenAPI + runs openapi-typescript
