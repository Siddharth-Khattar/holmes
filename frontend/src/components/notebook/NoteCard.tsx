...
export function NoteCard({
    ...
    const title = note.title || (note.type === "TEXT" ? "Untitled Text Note" : "Audio Recording");

    // Subtitle fallback
    const subtitle = note.subtitle || (note.type === "TEXT" && note.content
                        ...
                        <div className="flex items-start justify-between gap-2">
                            <div className="min-w-0 flex-1">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {!isGenerating && (note.content || note.audio_storage_path) && (
                                        <button
                                ...
                                <div className="space-y-3">
                                    ...
                                    {note.content ? (
                                        ...
                                        <p
                                            ...
                                            style={{ color: "var(--muted-foreground)" }}
                                        >
                                            {isGeneratingMetadata ? "Transcribing audio..." : "No transcription available"}
                                        </p>
                                    )}
                                </div>
                            )}
