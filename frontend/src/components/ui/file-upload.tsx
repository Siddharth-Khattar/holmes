...
interface FileUploadProps {
  ...
  /** When true, don't display files in this component (useful when upload status is shown elsewhere) */
  hideSelectedFiles?: boolean;
  /** When true, allows multiple file selection */
  multiple?: boolean;
  /** When true, component is disabled */
  disabled?: boolean;
}
...
export const FileUpload = ({
  ...
  const displayFiles = hideSelectedFiles ? [] : files;
