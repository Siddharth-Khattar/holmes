...
export const MOCK_FILES = {
  image: {
    ...
    redacted:
      "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=800&h=600&fit=crop&blur=100",
  },
  video: {
    original:
 ...
 */
export async function simulateRedaction(fileType: string): Promise<string> {
