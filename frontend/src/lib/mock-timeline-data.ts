  ...
  const events: TimelineEvent[] = [
    {
      ...
      description: 'Plaintiff filed formal complaint against defendant for breach of contract',
      date: new Date(baseDate.getTime() + 0 * 24 * 60 * 60 * 1000).toISOString(),
      layer: 'legal',
      ...
      updatedAt: new Date(baseDate.getTime() + 0 * 24 * 60 * 60 * 1000).toISOString(),
    },
    {
    ...
    },
    {
      ...
      description: 'Defendant submitted formal request to modify contract terms',
    ...
    },
    {
      ...
      description: 'Internal strategy meeting with legal team to discuss response',
      date: new Date(baseDate.getTime() + 22 * 24 * 60 * 60 * 1000).toISOString(),
      layer: 'strategy',
      sourceIds: ['doc-007'],
    ...
    },
    {
      ...
      description: 'Plaintiff formally rejected the modification request from defendant',
    ...
    },
    {
      ...
      description: 'All relevant documents and evidence collected from both parties',
      date: new Date(baseDate.getTime() + 35 * 24 * 60 * 60 * 1000).toISOString(),
      layer: 'evidence',
    ...
    },
    {
      ...
      date: new Date(baseDate.getTime() + 40 * 24 * 60 * 60 * 1000).toISOString(),
      layer: 'strategy',
      sourceIds: ['doc-013'],
      entityIds: ['entity-001', 'entity-002'],
      confidence: 0.87,
    ...
    },
    {
      ...
      date: new Date(baseDate.getTime() + 50 * 24 * 60 * 60 * 1000).toISOString(),
      layer: 'legal',
...
export function generateMockTimelineResponse(caseId: string): TimelineApiResponse {
